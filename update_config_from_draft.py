...
def main():
    ...
    # ==========================================
    # 7. IMAGE MAPPING (STRICT BODY/LIFESTYLE RULE)
    # ==========================================
    # Features (Body 1-3)
    replacements['MULTIROW_IMAGE_1'] = "images/body/body-01-lifestyle.webp"
    replacements['MULTIROW_IMAGE_2'] = "images/body/body-02-lifestyle.webp"
    replacements['MULTIROW_IMAGE_3'] = "images/body/body-03-lifestyle.webp"
    
    # Secrets (Body 4-6)
    replacements['SECRET_IMAGE_1'] = "images/body/body-04-lifestyle.webp"
    replacements['SECRET_IMAGE_2'] = "images/body/body-05-lifestyle.webp"
    replacements['SECRET_IMAGE_3'] = "images/body/body-06-lifestyle.webp"
    
    # Closer (Body 7)
    replacements['MULTIROW_IMAGE_4'] = "images/body/body-07-lifestyle.webp"
